/**
 * FASTLY VCL EXAMPLES - ADDRESS FUNCTIONS
 * 
...
/**
 * FUNCTION: addr.is_ipv4
 * 
 * PURPOSE: Determines if a given address is an IPv4 address
 * SYNTAX: addr.is_ipv4(IP address)
 * 
 * PARAMETERS:
...
sub vcl_recv {
  # EXAMPLE 1: Basic IPv4 detection
  ...
  # EXAMPLE 2: Conditional logic based on IP version
  ...
  # EXAMPLE 3: Error handling with string conversion
...
/**
 * FUNCTION: addr.is_ipv6
 * 
 * PURPOSE: Determines if a given address is an IPv6 address
 * SYNTAX: addr.is_ipv6(IP address)
 * 
 * PARAMETERS:
 *   - address: An IP address to check
 * 
...
/**
 * FUNCTION: addr.is_unix
 * 
 * PURPOSE: Determines if a given address is a Unix domain socket address
 * SYNTAX: addr.is_unix(IP address)
 * 
 * PARAMETERS:
...
sub vcl_recv {
  # EXAMPLE 1: Basic Unix socket detection
  ...
  # EXAMPLE 2: Backend connection type detection
...
/**
 * FUNCTION: addr.extract_bits
 * 
 * PURPOSE: Extracts a range of bits from an IP address
 * SYNTAX: addr.extract_bits(IP address, INTEGER offset, INTEGER length)
 * 
 * PARAMETERS:
 ...
 * 
 * RETURN VALUE: An integer containing the extracted bits
 */

sub vcl_recv {
  # EXAMPLE 1: Basic bit extraction
  ...
  # EXAMPLE 2: Subnet matching using bit extraction
  # This example demonstrates how to check if an IP is in a specific subnet
  # For a /24 subnet, we extract the first 24 bits
  ...
  # EXAMPLE 3: IPv6 subnet classification
  ...
  # EXAMPLE 4: Advanced network segmentation
 ...
 * 
 * This example demonstrates how all address functions can work together
 * to create a comprehensive IP-based security and routing system.
 */
