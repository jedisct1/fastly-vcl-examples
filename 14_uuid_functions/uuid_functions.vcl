/**
 * FASTLY VCL EXAMPLES - UUID FUNCTIONS
 * 
 ...
 * 
 * PURPOSE: Generates a random UUID (version 4)
 * SYNTAX: uuid.version4()
 * 
 * PARAMETERS: None
 * 
 * RETURN VALUE: A randomly generated UUID version 4 string
 */
...
sub vcl_recv {
  ...
  # EXAMPLE 2: Setting a request ID header
  ...
  # EXAMPLE 3: Generating multiple UUIDs
  ...
  # EXAMPLE 4: Creating a correlation ID for distributed tracing
  ...
  # EXAMPLE 5: Generating a cache key with UUID
/**
 * FUNCTION: uuid.version3
 * 
 * PURPOSE: Generates a name-based UUID (version 3) using MD5
 * SYNTAX: uuid.version3(STRING namespace, STRING name)
 * 
 * PARAMETERS:
 *   - namespace: The namespace UUID
 *   - name: The name to generate the UUID from
 * 
 * RETURN VALUE: A deterministic UUID version 3 string based on the namespace and name
 */

sub vcl_recv {
  # EXAMPLE 1: Basic name-based UUID generation
  ...
  # EXAMPLE 2: Generating consistent UUIDs for the same input
  ...
  # EXAMPLE 3: Generating UUIDs for different inputs
  ...
  # EXAMPLE 4: Using a custom namespace
  ...
  # EXAMPLE 5: Generating a user-specific UUID
...
/**
 * FUNCTION: uuid.version5
 * 
 * PURPOSE: Generates a name-based UUID (version 5) using SHA-1
 * SYNTAX: uuid.version5(STRING namespace, STRING name)
 * 
 * PARAMETERS:
 *   - namespace: The namespace UUID
 *   - name: The name to generate the UUID from
 * 
 * RETURN VALUE: A deterministic UUID version 5 string based on the namespace and name
 */

sub vcl_recv {
  # EXAMPLE 1: Basic name-based UUID generation with SHA-1
  declare local var.namespace STRING;
  declare local var.name STRING;
  declare local var.uuid STRING;
  ...
  # EXAMPLE 2: Comparing version 3 (MD5) and version 5 (SHA-1) UUIDs
  ...
  # EXAMPLE 3: Generating content identifiers
  ...
  # EXAMPLE 4: Generating UUIDs for different resources
  ...
  # EXAMPLE 5: Generating a deterministic cache key
 ...
 * FUNCTION: uuid.dns
 * 
 * PURPOSE: Generates a name-based UUID (version 5) using the DNS namespace
 * SYNTAX: uuid.dns(STRING name)
 * 
 * PARAMETERS:
 *   - name: The name to generate the UUID from
 * 
 * RETURN VALUE: A deterministic UUID version 5 string based on the DNS namespace and the provided name
 */

sub vcl_recv {
  # EXAMPLE 1: Basic DNS namespace UUID generation
  ...
  # EXAMPLE 2: Generating UUIDs for different domains
  ...
  # EXAMPLE 3: Generating UUIDs for subdomains
  ...
  # EXAMPLE 4: Using the host header as the domain
  ...
  # EXAMPLE 5: Generating a service identifier
 ...
 * FUNCTION: uuid.url
 * 
 * PURPOSE: Generates a name-based UUID (version 5) using the URL namespace
 * SYNTAX: uuid.url(STRING name)
 * 
 * PARAMETERS:
 *   - name: The name to generate the UUID from
 * 
 * RETURN VALUE: A deterministic UUID version 5 string based on the URL namespace and the provided name
 */

sub vcl_recv {
  # EXAMPLE 1: Basic URL namespace UUID generation
  ...
  # EXAMPLE 2: Generating UUIDs for different URLs
  ...
  # EXAMPLE 3: Generating a UUID for the current request URL
  ...
  # EXAMPLE 4: Generating content identifiers for different resources
  ...
  # EXAMPLE 5: Generating a deterministic cache key for a URL
 ...
 * FUNCTION: uuid.oid
 * 
 * PURPOSE: Generates a name-based UUID (version 5) using the OID namespace
 * SYNTAX: uuid.oid(STRING name)
 * 
 * PARAMETERS:
 *   - name: The name to generate the UUID from
 * 
 * RETURN VALUE: A deterministic UUID version 5 string based on the OID namespace and the provided name
 */

sub vcl_recv {
  # EXAMPLE 1: Basic OID namespace UUID generation
  ...
  # EXAMPLE 2: Generating UUIDs for different OIDs
  ...
  # EXAMPLE 3: Generating UUIDs for enterprise-specific OIDs
  ...
  # EXAMPLE 4: Using OID for service identification
  ...
  # EXAMPLE 5: Using OID for object identification
...
/**
 * FUNCTION: uuid.is_valid
 * 
 * PURPOSE: Checks if a string is a valid UUID
 * SYNTAX: uuid.is_valid(STRING uuid)
 * 
 * PARAMETERS:
...
sub vcl_recv {
  # EXAMPLE 1: Basic UUID validation
  declare local var.uuid STRING;
  ...
  # EXAMPLE 2: Validating a generated UUID
  ...
  # EXAMPLE 3: Validating an invalid UUID
  ...
  # EXAMPLE 4: Validating a UUID from a header
  ...
  # EXAMPLE 5: Conditional logic based on UUID validity
...
/**
 * FUNCTION: uuid.is_version3
 * 
 * PURPOSE: Checks if a string is a valid UUID version 3
 * SYNTAX: uuid.is_version3(STRING uuid)
 * 
 * PARAMETERS:
 *   - uuid: The string to check
 * 
...
sub vcl_recv {
  # EXAMPLE 1: Basic UUID version 3 validation
  declare local var.uuid STRING;
  ...
  # EXAMPLE 2: Validating a generated UUID version 3
  declare local var.namespace STRING;
  declare local var.name STRING;
  declare local var.generated_uuid STRING;
  ...
  # EXAMPLE 3: Validating a UUID version 4 (should be false)
  ...
  # EXAMPLE 5: Checking multiple UUID versions
...
/**
 * FUNCTION: uuid.is_version4
 * 
 * PURPOSE: Checks if a string is a valid UUID version 4
 * SYNTAX: uuid.is_version4(STRING uuid)
 * 
 * PARAMETERS:
 *   - uuid: The string to check
 * 
...
sub vcl_recv {
  # EXAMPLE 1: Basic UUID version 4 validation
  declare local var.uuid STRING;
  declare local var.is_v4 BOOL;
  ...
  # EXAMPLE 2: Validating a generated UUID version 4
  declare local var.generated_uuid STRING;
  ...
  # EXAMPLE 3: Validating a UUID version 3 (should be false)
  declare local var.namespace STRING;
  declare local var.name STRING;
  declare local var.uuid_v3 STRING;
  ...
  # EXAMPLE 5: Validating multiple UUIDs
  declare local var.uuid1 STRING;
  declare local var.uuid2 STRING;
  declare local var.uuid3 STRING;
...
/**
 * FUNCTION: uuid.is_version5
 * 
 * PURPOSE: Checks if a string is a valid UUID version 5
 * SYNTAX: uuid.is_version5(STRING uuid)
 * 
 * PARAMETERS:
 *   - uuid: The string to check
 * 
...
sub vcl_recv {
  # EXAMPLE 1: Basic UUID version 5 validation
  declare local var.uuid STRING;
  declare local var.is_v5 BOOL;
  ...
  # EXAMPLE 2: Validating a generated UUID version 5
  declare local var.namespace STRING;
  declare local var.name STRING;
  declare local var.generated_uuid STRING;
  ...
  # EXAMPLE 5: Validating different namespace UUIDs
 ...
 * 
 * This example demonstrates how multiple UUID functions can work together
 * to create a comprehensive UUID management system.
 */
