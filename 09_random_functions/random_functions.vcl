/**
 * FASTLY VCL EXAMPLES - RANDOM FUNCTIONS
 * 
 ...
 * FUNCTION: randombool
 * 
 * PURPOSE: Generates a random boolean value with a specified probability
 * SYNTAX: randombool(REAL probability)
 * 
 * PARAMETERS:
...
sub vcl_recv {
  # EXAMPLE 1: Basic random boolean generation
  ...
  # EXAMPLE 2: Random boolean with different probabilities
  ...
  # EXAMPLE 3: A/B testing with random boolean
  ...
  # EXAMPLE 4: Random sampling for logging
  ...
  # EXAMPLE 5: Feature flagging with random boolean
...
/**
 * FUNCTION: randombool_seeded
 * 
 * PURPOSE: Generates a random boolean value with a specified probability, using a seed
 * SYNTAX: randombool_seeded(REAL probability, STRING seed)
 * 
 * PARAMETERS:
 *   - probability: A number between 0.0 and 1.0 representing the probability of returning TRUE
...
sub vcl_recv {
  # EXAMPLE 1: Basic seeded random boolean generation
  declare local var.result1 BOOL;
  ...
  # EXAMPLE 2: User-specific A/B testing
  ...
  # EXAMPLE 3: Feature flagging with consistent user experience
  ...
  # EXAMPLE 4: Multiple experiments with the same user base
  ...
  # EXAMPLE 5: Consistent sampling for logging
 ...
 * SYNTAX: randomint(INTEGER from, INTEGER to)
 * 
 * PARAMETERS:
 *   - from: The lower bound of the range (inclusive)
 *   - to: The upper bound of the range (inclusive)
 * 
 * RETURN VALUE: A random integer between from and to, inclusive
 */
...
sub vcl_recv {
  ...
  # EXAMPLE 2: Random integer with different ranges
  ...
  # EXAMPLE 3: Load balancing with random integer
  ...
  # EXAMPLE 4: Random delays for testing
...
/**
 * FUNCTION: randomint_seeded
 * 
 * PURPOSE: Generates a random integer within a specified range, using a seed
 * SYNTAX: randomint_seeded(INTEGER from, INTEGER to, STRING seed)
 * 
 * PARAMETERS:
 *   - from: The lower bound of the range (inclusive)
 *   - to: The upper bound of the range (inclusive)
 *   - seed: A string used as a seed for the random number generator
 * 
 * RETURN VALUE: A random integer between from and to, inclusive (deterministic for the same seed)
 */

sub vcl_recv {
  # EXAMPLE 1: Basic seeded random integer generation
  declare local var.result1 INTEGER;
  declare local var.seed STRING;
  ...
  # EXAMPLE 2: User-specific variant assignment
  ...
  # EXAMPLE 3: Consistent shard assignment
  ...
  # EXAMPLE 5: Deterministic cache key generation
 ...
 * SYNTAX: randomstr(INTEGER length [, STRING charset])
 * 
 * PARAMETERS:
...
sub vcl_recv {
  # EXAMPLE 1: Basic random string generation
  ...
  # EXAMPLE 2: Random string with different lengths
  ...
  # EXAMPLE 3: Random string with custom character set
  ...
  # EXAMPLE 4: Generating a request ID
  ...
  # EXAMPLE 5: Generating a CSRF token
 ...
 * 
 * This example demonstrates how multiple random functions can work together
 * to create a comprehensive random value system for various purposes.
 */
 ...
 *    - Use seeded functions (randombool_seeded, randomint_seeded) when you need consistent results
 *      for the same input, such as user-specific feature flags or A/B testing
 *    - Use non-seeded functions (randombool, randomint, randomstr) when you need true randomness,
 *      such as load balancing or sampling
 * 
